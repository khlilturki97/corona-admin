...
$.AdminCompass = {}, $.AdminCompass.options = {
  ...
  activate: function () {
    ...
    var a = $("body"), t = $(".navbar .navbar-header .bars"), s = a.width();
  ...
  activate: function () {
    var t = this, s = $("#rightsidebar"), r = $(".overlay");
    $(window).on("click", function (e) {
      var a = $(e.target);
...
function skinChanger() {
  $(".right-sidebar .choose-skin li").on("click", function () {
    var e = $("body"), a = $(this), t = $(".right-sidebar .choose-skin li.active").data("theme");
